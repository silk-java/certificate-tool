...
public class ChineseNameGenerator {
    private static final List<String> surnames = Arrays.asList(
            ...
            "白", "怀", "蒲", "台", "从", "鄂", "索", "咸", "籍", "赖", "卓", "蔺", "屠", "蒙",
            "池", "乔", "阴", "郁", "胥", "能", "苍", "双", "闻", "莘", "党", "翟", "谭", "贡",
            "劳", "逢", "姬", "申", "扶", "堵", "冉", "宰", "郦", "雍", "却", "璩", "桑", "桂",
            ...
            "仉督", "子车", "颛孙", "端木", "巫马", "公西", "漆雕", "乐正", "壤驷", "公良", "拓拔", "夹谷",
            "宰父", "谷梁", "段干", "百里", "东郭", "南门", "呼延", "羊舌", "微生", "岳帅", "缑亢", "况后",
            "有琴", "梁丘", "左丘", "东门", "西门", "商牟", "佘佴", "伯赏", "南宫", "墨哈", "谯笪", "年爱",
            "阳佟", "第五", "言福");
    
    private static final List<String> givenNames = Arrays.asList(
            "伟", "芳", "娜", "秀英", "敏", "静", "丽", "强", "磊", "军", "洋", "勇", "艳", "杰", "娟",
            "涛", "明", "超", "秀兰", "霞", "平", "刚", "桂英", "博", "秀珍", "凯", "秀华", "红", "敏华",
            "燕", "文", "兰", "进", "凤英", "龙", "英", "晓", "健", "世", "小红", "美丽", "瑞", "弘",
            "小伟", "小芳", "小杰", "小敏", "小静", "小刚", "小霞", "小明", "小军", "小洋", "小勇", "小艳", "小涛", "小平");
    
    public static void main(String[] args) {
        ArrayList<String> names = generateRandomNames(100);
    ...
    public static ArrayList<String> generateRandomNames(int count) {
